      ...
      <div className="container about-page">
       <span className="tags top-tags">&lt;body&gt;</span>
        <div className="text-zone">
          ...
          <p>
          Welcome to my site! My name is Abkar and I’ve been teaching myself how to design and code websites from scratch. My determination keeps me waking up every day wanting to see more, do more, learn more. I have always been creative and driven. 
          </p>
          <p align="LEFT">
